...
/**
* 通知 控制层单元测试com.lzpeng.minimal.common.jpa.controller
* @author: Lzpeng
*/
@Slf4j
@EnableWebMvc
...
@Generated(value = "com.lzpeng.minimal.generate.jpa.JpaCodeGenerator", date = "2020-6-25 2:02:06", comments = "通知 控制层单元测试")
...
//                .contentType(MediaType.APPLICATION_FORM_URLENCODED) // @RequestParam 解析
    ...
    */
    ...
    public void testDelete() throws Exception {
        String id = "{}";
        mockMvc.perform(delete("/system/notice/" + id)
    ...
    */
    ...
    public void testUpdate() throws Exception {
        ...
        Notice notice = new Notice();
        String content = objectMapper.writeValueAsString(notice);
        String result = mockMvc.perform(put("/system/notice/" + id)
                .content(content) // @RequestBody 解析
    ...
    */
    ...
    public void testQuery() throws Exception {
        ...
        Notice notice = new Notice();
        String content = objectMapper.writeValueAsString(notice);
        String result = mockMvc.perform(get("/system/notice/"+ page + "/" + size)
                .content(content)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
    ...
    */
    ...
    public void testFindById() throws Exception {
        String id = "{}";
        String result = mockMvc.perform(get("/system/notice/"+ id)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
