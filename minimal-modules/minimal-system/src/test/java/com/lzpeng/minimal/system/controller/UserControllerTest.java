...
/**
* 用户 控制层单元测试com.lzpeng.minimal.common.jpa.controller
* @author: Lzpeng
*/
@Slf4j
@EnableWebMvc
...
@Generated(value = "com.lzpeng.minimal.generate.jpa.JpaCodeGenerator", date = "2020-6-25 2:02:06", comments = "用户 控制层单元测试")
...
public class UserControllerTest {
    ...
    */
    ...
    public void testSave() throws Exception {
        User user = new User();
        user.setUsername("12412414");
        user.setPassword("123456");
        String content = objectMapper.writeValueAsString(user);
        String result = mockMvc.perform(post("/system/user")
...
//                .contentType(MediaType.APPLICATION_FORM_URLENCODED) // @RequestParam 解析
    ...
    */
    ...
    public void testDelete() throws Exception {
        String id = "{}";
        mockMvc.perform(delete("/system/user/" + id)
    ...
    */
    ...
    public void testUpdate() throws Exception {
        ...
        User user = new User();
        String content = objectMapper.writeValueAsString(user);
        String result = mockMvc.perform(put("/system/user/" + id)
                .content(content) // @RequestBody 解析
    ...
    */
    ...
    public void testQuery() throws Exception {
        ...
        User user = new User();
        String content = objectMapper.writeValueAsString(user);
        String result = mockMvc.perform(get("/system/user/"+ page + "/" + size)
                .content(content)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
    ...
    */
    ...
    public void testFindById() throws Exception {
        String id = "{}";
        String result = mockMvc.perform(get("/system/user/"+ id)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
