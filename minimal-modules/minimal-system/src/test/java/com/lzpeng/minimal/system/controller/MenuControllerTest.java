...
/**
* 权限菜单 控制层单元测试com.lzpeng.minimal.common.jpa.controller
* @author: Lzpeng
*/
@Slf4j
@EnableWebMvc
...
@Generated(value = "com.lzpeng.minimal.generate.jpa.JpaCodeGenerator", date = "2020-6-25 2:02:06", comments = "权限菜单 控制层单元测试")
...
public class MenuControllerTest {
    ...
    */
    ...
    public void testSave() throws Exception {
        ...
        String result = mockMvc.perform(post("/system/menu")
...
//                .contentType(MediaType.APPLICATION_FORM_URLENCODED) // @RequestParam 解析
    ...
    */
    ...
    public void testDelete() throws Exception {
        String id = "{}";
        mockMvc.perform(delete("/system/menu/" + id)
    ...
    */
    ...
    public void testUpdate() throws Exception {
        ...
        Menu menu = new Menu();
        String content = objectMapper.writeValueAsString(menu);
        String result = mockMvc.perform(put("/system/menu/" + id)
                .content(content) // @RequestBody 解析
    ...
    */
    ...
    public void testQuery() throws Exception {
        ...
        Menu menu = new Menu();
        String content = objectMapper.writeValueAsString(menu);
        String result = mockMvc.perform(get("/system/menu/"+ page + "/" + size)
                .content(content)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
    ...
    */
    ...
    public void testFindById() throws Exception {
        String id = "{}";
        String result = mockMvc.perform(get("/system/menu/"+ id)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
