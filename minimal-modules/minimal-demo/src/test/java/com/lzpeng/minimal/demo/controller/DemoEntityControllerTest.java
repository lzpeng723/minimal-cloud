...
/**
* 测试实体 控制层单元测试com.lzpeng.minimal.common.jpa.controller
...
@Generated(value = "com.lzpeng.minimal.generate.jpa.JpaCodeGenerator", date = "2020-7-7 18:31:21", comments = "测试实体 控制层单元测试")
...
public class DemoEntityControllerTest {
    ...
    * 类名称
    */
    private static final String CLASS_NAME = "demoEntity";
    /**
    * 测试实体列表权限
    */
    ...
    */
    ...
    public void testSave() throws Exception {
        ...
        demoEntity.setName("asfasfs");
        demoEntity.setNumber("fsdgewgewew");
        String content = objectMapper.writeValueAsString(demoEntity);
        String result = mockMvc.perform(post("/demo/demoEntity")
...
//                .contentType(MediaType.APPLICATION_FORM_URLENCODED) // @RequestParam 解析
    ...
    */
    ...
    public void testDelete() throws Exception {
        String id = "{}";
        mockMvc.perform(delete("/demo/demoEntity/" + id)
    ...
    */
    ...
    public void testUpdate() throws Exception {
        ...
        DemoEntity demoEntity = new DemoEntity();
        String content = objectMapper.writeValueAsString(demoEntity);
        String result = mockMvc.perform(put("/demo/demoEntity/" + id)
                .content(content) // @RequestBody 解析
    ...
    */
    ...
    public void testQuery() throws Exception {
        ...
        DemoEntity demoEntity = new DemoEntity();
        String content = objectMapper.writeValueAsString(demoEntity);
        String result = mockMvc.perform(get("/demo/demoEntity/"+ page + "/" + size)
                .content(content)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
    ...
    */
    ...
    public void testFindById() throws Exception {
        String id = "{}";
        String result = mockMvc.perform(get("/demo/demoEntity/"+ id)
                .contentType(MediaType.APPLICATION_JSON_UTF8) // 请求类型
                .accept(MediaType.APPLICATION_JSON_UTF8)) // 响应类型
                .andExpect(status().isOk())
