 ...
 * @EnableAuthorizationServer 启用认证服务器 几种OAuth2协议生效
 * @author: Lzpeng
 */
@Configuration
...
public class AuthenticationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        // 设置 security 的 authenticationManager
        endpoints.authenticationManager(authenticationManager)
                // 设置获取用户 UserDetailsService
                ...
                // 设置异常处理器，在这里设置无效，需要在@EnableResourceServer所注解的类中设置
     ...
     * @throws Exception 若不能创建客户端存储则抛异常
     */
    @Override
